...
function Home(){
    ...
    return(
        <div>
            ...
            <MainSlider/>
            <AboutUs/>
            <Solutions  languageId={languageId} id={selectedId}/>
            <Contact/>
            <Blogs languageId={languageId} id={selectedId}/>
            <Brand  languageId={languageId} id={selectedId}/>
            <Footer languageId={languageId} id={selectedId}/>
        </div>
    )
